...
const ContactUs = () =>{
    return(
        <div className="contactUsContainer">
            ...
            Contact Us: For inquiries, urgent needs, or to request a quote, reach out to us at 
            moc@amxsupport.com. Trust AMX Support to elevate your aircraft maintenance experience 
            – where precision meets passion. Fly with confidence, fly with AMX Support!
            </p>
